    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficeSchedule", x => new { x.OfficesId, x.SchedulesId });
                    table.ForeignKey(
                        name: "FK_OfficeSchedule_Offices_OfficesId",
                        column: x => x.OfficesId,
                        principalTable: "Offices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfficeSchedule_Schedules_SchedulesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegionService", x => new { x.RegionsId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_RegionService_Regions_RegionsId",
                        column: x => x.RegionsId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegionService_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegionService_ServicesId",
                table: "RegionService",
                column: "ServicesId");
        }
